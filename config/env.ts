...
export const env = {
  ...
  oauthNewPassword: process.env.OAUTH_NEW_PASSWORD ?? '',
  ...
  searchProductName: process.env.SEARCH_PRODUCT_NAME ?? '',
  authStorageState: process.env.AUTH_STORAGE_STATE ?? '.auth/user.json'
} as const;
